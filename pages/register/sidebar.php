<div id='registerSidebar'>
  <input type='text' id='scanField' class='form-control' placeholder='Scan' />
  <button class='btn btn-sm btn-primary' id='manualItem' data-toggle='modal' data-target='#manualItemModal' style='margin-top: 10px;'>Add Manual Item</button>
  <button class='btn btn-sm btn-secondary' id='lookupItem' data-toggle='modal' data-target='#lookupItemModal'>Lookup Item</button>
